...
\begin{document}
    ...
    \section{Technologies}        
        \begin{onecolentry}
            \textbf{Languages:} Embedded C(ESP-IDF), Python, C++, Go, JavaScript, SQL, Arduino
        \end{onecolentry}
        
        \vspace{0.1 cm}
        \begin{onecolentry}
            \textbf{Frameworks \& Libraries:} OpenCV, Flask, FastAPI, ROS (Smach, Script, Packages), NextJS, React, Svelte, PyTorch, LaTeX, HTML
        \end{onecolentry}
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item GPA: 3.28/4.0 (Second Honor)%(\href{https://example.com}{a link to somewhere})
